...
public class mk_courseservice {
    ...
    /* 后台课程查询 */
    public PageDatas<Map<String, Object>> findcourse(int page, int limit, Integer mksid, Integer mkuid, String mkcsid, String mkdfid) {
        PageHelper.startPage(page, limit);

        List<Map<String, Object>> findcourse = mk_coursedao.findcourse(mksid, mkuid, mkcsid, mkdfid);

        PageInfo<Map<String, Object>> pageInfo = new PageInfo<Map<String, Object>>(findcourse);
    ...
    public List<mk_course> findAll() {
        return mk_coursedao.selectAll();
    }


    public List<mk_course> findsu(Integer mksid, Integer mkuid) {

        return mk_coursedao.findsu(mksid, mkuid);

    }

    /* 添加课程 后台 */
    public int addMk_course(mk_course mk_course){

        return  mk_coursedao.insertSelective(mk_course);
    }

    /* 后台根据课程标题和讲师编号查询唯一编号 */
    /*public Integer findmkcsid(String mkctitle,Integer mksid){
        return mk_coursedao.findmkcsid(mkctitle,mksid);
    }*/

    public Integer findmkcsid(mk_course m){
        System.out.println("m = " + m);
        return mk_coursedao.findmkcsid(m);
    }


    public Integer updateTile(String mkctime,Integer mkcsid){
        return mk_coursedao.updateTile(mkctime,mkcsid);
    }

    public int deletecsid(Integer mkcsid){
        return mk_coursedao.deletecsid(mkcsid);
    }

    public int selectmkcsid(String mkctitle,Integer mkuid,Integer mksid){
        return mk_coursedao.selectmkcsid(mkctitle,mkuid,mksid);
    }
