...
public class GetMessageCode  {
    ...
    private static final String ACCOUNT_SID = "5fc3e3850aead54c8d1f2410889e3f11";
    private static final String AUTH_TOKEN = "d6f57761829ef729b552859d45244f7c";
    ...
    public static String getCode(String phone) {
        ...
        String tamp = "【佰倍】亲爱的用户，您的短信验证码为"+rod+"，,2分钟内有效，若非本人操作请忽略。";
        ...
        System.out.println("defaultRespCode = " + defaultRespCode);
        System.out.println("defaultRespCode.equals(respCode) = " + defaultRespCode.equals(respCode));
